...
<div class="container mt-3" >
          <div class="row">
            ...
            <div class="card shadow-sm col-lg-3 col-md-2 col-sm-4"id="output">
              ...
              <div class="row d-flex justify-content-center mt-5 mb-2 ">
                <button type="button" class="btn btn-secondary" onclick="cartIn()">장바구니</button>
              </div>

              <div class="row d-flex justify-content-center mt-5 mb-2">
                <button type="button" class="btn btn-secondary" onclick="requestPay();">바로구매</button>
              </div>
            </div>
...
<script> 
        ...
        function requestPay() {
    		...
    		IMP.request_pay({
    		    ...
    		    amount : '<c:out value="${book.bookPrice}"/>',
    		    buyer_email : '',
    		        ...
    		        $.ajax({
    				    ...
    				    data: {
    				    	"memberID": '<c:out value="${Smember.memberID}"/>',
    				       	"bookIDList": '<c:out value="${book.bookID}"/>',
    				        "bookNameList": '<c:out value="${book.bookName}"/>',
    				        "bookimgList": '<c:out value="${book.bookimg}"/>',
    				        "bookStockList": $("#hopeamount").val(),
    				        "bookPriceList": '<c:out value="${book.bookPrice}"/>',
